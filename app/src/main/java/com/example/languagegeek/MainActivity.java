package com.example.languagegeek;
...
public class MainActivity extends AppCompatActivity {
    ...
    String [] fromLanguages = {"From", "English", "African", "Arabic", "Belarusian",
            "Bulgarian", "Bengali", "Catalan", "Czech", "Welsh", "Hindi", "Urdu"};

    String [] toLanguages = {"To", "English", "African", "Arabic", "Belarusian",
            "Bulgarian", "Bengali", "Catalan", "Czech", "Welsh", "Hindi", "Urdu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceEdit = findViewById(R.id.edtSource);
        ...
        translateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sourceEdit.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "Please select translated Language!", Toast.LENGTH_SHORT).show();
                } else {
            ...
            public void onSuccess(Void unused) {
                ...
                translator.translate(source).addOnSuccessListener(new OnSuccessListener<String>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MainActivity.this, "Failed to translate Text!" +e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).addOnFailureListener(new OnFailureListener() {
